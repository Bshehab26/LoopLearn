 ...
 * Layout for instructor dashboard with sidebar navigation only (no top navbar)
 * 
...
import { 
  ...
  HiUser, HiLogout, HiMenu, HiX, HiHome
} from 'react-icons/hi';
...
const SIDEBAR_ITEMS = [
  { path: ROUTES.INSTRUCTOR_DASHBOARD, label: 'Dashboard', icon: HiChartBar, end: true },
  { path: ROUTES.INSTRUCTOR_ADD, label: 'Add New Course', icon: HiPlusCircle, end: true },
  { path: ROUTES.INSTRUCTOR_COURSES, label: 'My Courses', icon: HiBookOpen, end: true },
  { path: ROUTES.INSTRUCTOR_STUDENTS, label: 'Enrolled Students', icon: HiUserGroup, end: true },
  { path: ROUTES.INSTRUCTOR_PROFILE, label: 'My Profile', icon: HiUser, end: true },
];
